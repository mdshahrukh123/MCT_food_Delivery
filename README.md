<h1 align="center"> 
Food Delivery platform Management</h1>

* This repository contains the code for a Food Delivery platform Management System. The system includes functionality for managing restaurants, as well as for user authentication and authorization.

* The Food Delivery platformt management system is a web-based application that uses Spring Boot. It 
...
* PUT /food/foodid/{foodRecordId}

* GET /Foodmanagement/foodid/{restaurantid}
